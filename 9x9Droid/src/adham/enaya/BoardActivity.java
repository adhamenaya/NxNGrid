...
public class BoardActivity extends Activity implements UpdatePlayer {
	...
	private void updatePlayer() {
		...
		tvWhiteEarnCells.setText(String
				.valueOf(mBoard.mWhitePlayer.mEarnedmPieces.size()));
		tvBlackEarnCells.setText(String
				.valueOf(mBoard.mBlackPlayer.mEarnedmPieces.size()));
	...
	private void displayBoard() {
		for (int i = 0; i < mBoard.cells.size(); i++) {
			...
			vi.setText(mBoard.cells.get(i).coorX + "-"
					+ mBoard.cells.get(i).coorY);
			cv.addView(vi);
			...
			params.setMargins((int) mBoard.cells.get(i).x1,
					(int) mBoard.cells.get(i).y1, 0, 0);
